        ...
        'client_information' => [
            ...
            'fields' => [
                ...
                [
                    ...
                    'label' => 'Organization Type (Sole Prop, Corp, Others)',
                    'type' => 'select',
                    'required' => true,
                    'options' => [
                ...
                ['name' => 'online_shops_for_profiling', 'label' => 'Online Shops For Profiling Purposes', 'type' => 'textarea', 'required' => false],
            ],
        ],
        'treasurer_details' => [
            ...
            'fields' => [
                ...
                ['name' => 'treasurer_first_name', 'label' => 'Treasurer First Name', 'type' => 'text', 'required' => true],
                ['name' => 'treasurer_middle_name', 'label' => 'Treasurer Middle Name', 'type' => 'text', 'required' => false],
                ['name' => 'treasurer_surname', 'label' => 'Treasurer Surname', 'type' => 'text', 'required' => true],
                ['name' => 'treasurer_address', 'label' => 'Treasurer Address', 'type' => 'text', 'required' => true],
                ['name' => 'treasurer_mobile_number', 'label' => 'Treasurer Mobile Number', 'type' => 'text', 'required' => true],
                ['name' => 'treasurer_birthdate', 'label' => 'Treasurer Birthdate', 'type' => 'date', 'required' => true],
                ['name' => 'treasurer_tin', 'label' => 'Treasurer Tax Identification Number', 'type' => 'text', 'required' => true],
