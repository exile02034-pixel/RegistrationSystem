...
import { Building2, FileUp, Pencil, Trash2, UserPlus } from 'lucide-vue-next'
...
const icon = computed(() => {
  ...
  if (props.type === 'form.section.updated') return Pencil
...
<template>
  <component :is="icon" :class="props.class ?? 'h-4 w-4'" />
</template>
