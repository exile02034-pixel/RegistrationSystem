...
import { useProfileSettingsPage } from '@/composables/settings/useProfileSettingsPage';
import AppLayout from '@/layouts/AppLayout.vue';
import SettingsLayout from '@/layouts/settings/Layout.vue';
import { send } from '@/routes/verification';
import type { ProfileSettingsPageProps } from '@/types';

defineProps<ProfileSettingsPageProps>();
const { breadcrumbItems, user } = useProfileSettingsPage();
</script>
